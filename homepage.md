...
<div style="background: #8b7da7;">
  <p style="background: #20a5de; font-weight: 300; color: #fff; padding: 15px 0; font-size: 20px;"><span style="font-weight: 400;">Start Date:</span> 01/10/19 | <span style="font-weight: 400;">End Date:</span> 02/1/19 </p>
</div>
...
<div style="width: 100%; clear: both; float: left; padding-top: 40px; padding-bottom: 40px;">
  <div style="width: 85%; margin: auto;">
    ...
    <div style="padding-left: 20px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="http://reinidays.files.wordpress.com/2011/09/ron-swanson.jpg">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Account Executive</span>

        <span style="font-weight: 300;">Ron Swanson

        ron.swanson@looker.com</span></p>
      </div>
    </div>

    <div style="padding-left: 40px;float:left; width: 50%;">
      <img style="border-radius: 50%; width: 100px; float:left;" src="https://wwwstatic.lookercdn.com/people/team/peter_whitehead_v0001.jpg">
      <div style="float:left; text-align: left; padding-left: 15px; padding-top: 15px;">
        <p><span style="font-size: 16px;">Analyst</span>

        <span style="font-weight: 300;">Peter Whitehead

        peter.whitehead@looker.com</span></p>
      </div>
    </div>
